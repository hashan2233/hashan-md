...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+94759588769'; // Replace this with the actual owner number
        const ownerName = 'HASHAN-MD'; // Replace this with the owner's name
        ...
        await conn.sendMessage(from, {
            text: `HASHAN-MD`,
            contextInfo: {
                mentionedJid: [ownerNumber.replace('94759588769') + '+94759588769@s.whatsapp.net'], // Mention the owner
